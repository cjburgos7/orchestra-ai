...
export type StartupBrief = {
  ...
  /** World-depth fields — generated by expanded pipeline */
...
export type StartupProject = {
  ...
  /** World-depth fields — populated by expanded generation pipeline */
  founderMission?: string;
  marketPositioning?: string;
  brandPersonality?: string;
  businessModel?: string;
...
export function briefFromProject(project: StartupProject): StartupBrief {
  return {
    ...
    founderMission: project.founderMission,
    marketPositioning: project.marketPositioning,
    brandPersonality: project.brandPersonality,
    businessModel: project.businessModel,
    launchStrategy: project.launchStrategy,
    growthOpportunities: project.growthOpportunities,
    competitiveEdge: project.competitiveEdge,
