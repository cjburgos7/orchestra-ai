    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: "oklch(32% .012 275)", fontWeight: 500 }}>Customers</span>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "48px 24px" }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 16, color: "oklch(52% .012 270)", lineHeight: 1.65, margin: 0, maxWidth: 480 }}>
            Know your users deeply. Track behavior, segment audiences, and understand what drives retention.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: 20, fontWeight: 400, color: "oklch(22% .012 270)", margin: "0 0 8px" }}>
            Customer intelligence is coming
          </h2>
          <p style={{ fontSize: 14, color: "oklch(52% .012 270)", margin: "0 0 20px", lineHeight: 1.6 }}>
            Understand who your best customers are, what they need, and how to reach more like them.
          </p>
          <Link href="/app" style={{
