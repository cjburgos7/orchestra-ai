    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: 13, color: "oklch(32% .012 275)", fontWeight: 500 }}>Analytics</span>
        </div>
      </nav>
      ...
      <div style={{ maxWidth: 920, margin: "0 auto", padding: "48px 24px" }}>
        <div style={{ marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 16, color: "oklch(52% .012 270)", lineHeight: 1.65, margin: 0, maxWidth: 480 }}>
            Business intelligence for founders. Metrics that matter, in context, without the noise.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h2 style={{ fontFamily: SERIF, fontSize: 20, fontWeight: 400, color: "oklch(22% .012 270)", margin: "0 0 8px" }}>
            Analytics dashboard is coming
          </h2>
          <p style={{ fontSize: 14, color: "oklch(52% .012 270)", margin: "0 0 20px", lineHeight: 1.6 }}>
            MRR, CAC, LTV, churn — the metrics that determine whether your startup is working.
          </p>
          <Link href="/app" style={{
